...
const CarGame = () => {
  ...
  // Movement handlers with throttle
  ...
  return (
    <div className="min-h-screen flex flex-col items-center justify-start py-10 bg-gradient-to-b from-gray-900 to-gray-800 text-white px-4 font-sans relative overflow-hidden">
      {/* Game Box */}
      ...
      {gameRunning && (
        <div className="mt-6 flex flex-row flex-wrap justify-center gap-4">
          <button
            onClick={moveLeft}
            className="bg-cyan-600 hover:bg-cyan-500 px-6 py-3 rounded-lg text-lg font-semibold shadow-md flex items-center gap-2"
          >
      ...
      <AnimatePresence>
        {showModes && (
          <motion.div
            ...
            className="mt-8 bg-gray-900 border-2 border-cyan-400 p-8 rounded-2xl w-full max-w-md text-center shadow-xl absolute top-[50%] left-[50%] -translate-x-1/2 -translate-y-1/2 z-50"
          >
      ...
      <AnimatePresence>
        {showTruth && (
          <motion.div
            ...
            exit={{ y: 40, opacity: 0 }}
            className="mt-8 bg-gray-900 p-6 rounded-2xl border-2 border-pink-400 text-center w-full max-w-md shadow-xl absolute top-[50%] left-[50%] -translate-x-1/2 -translate-y-1/2 z-50"
          >
            <h3 className="text-2xl font-bold text-pink-400 mb-4">
              {selectedMode.toUpperCase()} Truth
            </h3>
