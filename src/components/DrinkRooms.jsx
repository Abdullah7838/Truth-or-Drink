...
function DrinkRooms({ setMainUsername }) {
  ...
  return (
    <>
      <Helmet>
        <title>Truth or Drink– Play Online With Friends</title>
        <meta
          name="description"
          content="Play Truth or Drink online with friends. Choose a room or create a room and enjoy fun challenges!"
        />
        <meta
          name="keywords"
          content="truth or drink, online party game, online game, drink game , online truth or drink "
        />
        <meta
          property="og:title"
          content="Truth or Drink– Online Play With Friends"
        />
        <meta
