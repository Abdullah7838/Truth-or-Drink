...
import SpinnerWheel from "./SpinnerWheel"; // Assuming SpinnerWheel is a separate component
  ...
  return (
         ...
         <div className="min-h-screen flex flex-col items-center justify-center p-6 relative overflow-hidden bg-gradient-to-br from-purple-900 via-blue-900 to-indigo-900">
             ...
             <div className="max-w-4xl w-full  space-y-8 relative z-10">
               ...
               {/* Input Section */}
               <div className="bg-white/10 backdrop-blur-lg border border-white/20 shadow-2xl rounded-lg p-6 overflow-y-auto">
                 <div className="flex flex-col sm:flex-row gap-3">
                   <input
                     type="text"
                     className="flex-1 bg-white/20 border border-white/30 text-white placeholder:text-white/60 focus:bg-white/30 transition-all duration-300 px-4 py-2 rounded-lg focus:outline-none focus:ring-2 focus:ring-white/50"
                     ...
                     {items.map((item, i) => (
                       ...
                       >
                         ...
                         <button
                           ...
                           className=" group opacity-100 transition-opacity duration-300 text-red-300 hover:text-red-500 p-1 rounded disabled:opacity-30 disabled:cursor-not-allowed"
                         >
